...
public class KafkaConfig {
    ...
    private String PRODUCT_VALIDATION_SUCCESS;

    @Value("${spring.kafka.topic.product-validation-fail}")
    private String PRODUCT_VALIDATION_FAIL;
    ...
    public NewTopic inventorySuccessTopic() {
        return createTopic(PRODUCT_VALIDATION_SUCCESS);
    }

    @Bean
    public NewTopic inventorySuccessFail() {
        return createTopic(PRODUCT_VALIDATION_FAIL);
    }
